// enterrement-script.js

document.addEventListener('DOMContentLoaded', function() {
  const serviceName = "enterrement"; // Nom du service pour récupérer les configurations
  ...
  if (!datePicker || !messageDiv || !paypalButtonDiv || !bookButton || !hamburgerButton || !mobileMenu) {
    console.error("Un ou plusieurs éléments HTML requis sont manquants sur la page Funérailles.");
    return;
  }
  ...
  try {
    if (typeof serviceLeadTimes !== 'undefined' && serviceLeadTimes && serviceLeadTimes[serviceName] !== undefined) {
      ...
      // Pour les funérailles, le délai est souvent de 0, donc minDate peut être aujourd'hui.
      // Si serviceLeadTimes[serviceName] est 0, minDate.getDate() + 0 ne change rien.
